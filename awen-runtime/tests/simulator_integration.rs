...
mod simulator_integration_tests {
    ...
    fn test_photon_loss_rate_verification() {
        ...
        let loss_rate: f64 = 0.01;
        let expected_transmission: f64 = 1.0 - loss_rate;
    ...
    fn test_dark_count_poisson_distribution() {
        ...
        let dark_count_rate: f64 = 1000.0; // Hz
        let integration_time: f64 = 1e-6; // seconds
        let expected: f64 = dark_count_rate * integration_time;
    ...
    fn test_phase_noise_accumulation() {
        ...
        let linewidth: f64 = 1000.0; // Hz
        let measurement_time: f64 = 0.001; // seconds
        let expected_jitter: f64 = (linewidth * measurement_time).sqrt();
    ...
    fn test_kerr_phase_shift_scaling() {
        ...
        let chi: f64 = 0.1; // rad/(photon·cm)
        let distance: f64 = 1.0; // cm
    ...
    fn test_thermal_noise_negligible_at_room_temp() {
        ...
        let planck_k_b: f64 = 1.381e-23;
        let hbar: f64 = 1.055e-34;
        let omega: f64 = 1.22e15; // rad/s for 1550 nm

        let exponent: f64 = (hbar * omega) / (planck_k_b * temp_k);
        let n_th: f64 = 1.0 / ((exponent).exp() - 1.0);

        // Accept a small but non-zero thermal population at IR frequencies
        assert!(n_th < 1e-10); // Negligible for practical purposes
    }
    ...
    fn test_heterodyne_frequency_jitter_snr_degradation() {
        ...
        let linewidth: f64 = 1000.0; // Hz
        let measurement_time_short: f64 = 1e-6; // 1 µs
        let measurement_time_long: f64 = 1e-3; // 1 ms
    ...
    fn test_heterodyne_magnitude_phase_extraction() {
        ...
        let magnitude: f64 = (i_quad.powi(2) + q_quad.powi(2)).sqrt();
        let phase: f64 = q_quad.atan2(i_quad);
    ...
    fn test_photon_counting_statistics() {
        ...
        let alpha_squared: f64 = 2.0; // Coherent state amplitude²
    ...
    fn test_phase_calibration_drift_rate() {
        ...
        let drift_rate: f64 = 1e-5; // rad/s
        let elapsed_time: f64 = 1000.0; // seconds (16.7 minutes)
        let accumulated_drift: f64 = drift_rate * elapsed_time;
    ...
    fn test_phase_calibration_expiration() {
        ...
        let max_drift_before_expiration: f64 = 300e-6; // 300 µrad
        let drift_rate: f64 = 1e-5; // rad/s

        let time_to_expire: f64 = max_drift_before_expiration / drift_rate;
        // Given the units used, expiration occurs on the order of tens of seconds
        assert!((time_to_expire - 30.0).abs() < 0.1); // ~30 seconds
    }

    #[test]
    fn test_dark_count_calibration_expiration() {
        // Test: Dark count calib expires after >10% drift
        let calibration_threshold: f64 = 0.10; // 10% drift
        let drift_coefficient: f64 = 0.0001; // per second

        let time_to_expire: f64 = calibration_threshold / drift_coefficient;
    ...
    fn test_temperature_dependent_drift() {
        ...
        let temp_25c: f64 = 25.0 + 273.15;
        let temp_35c: f64 = 35.0 + 273.15;

        let drift_coeff_25: f64 = 0.0001 * temp_25c / 298.15; // Normalized to 25°C
        let drift_coeff_35: f64 = 0.0001 * temp_35c / 298.15;
    ...
    fn test_simulator_capabilities() {
        ...
        let modes = ["Homodyne", "Heterodyne", "DirectDetection"];
    ...
    fn test_simulator_measurement_mode_priority() {
        ...
        let priority_order = [("DirectDetection", 3), ("Heterodyne", 2), ("Homodyne", 1)];
    ...
    fn test_simulator_phase_execution_feedback() {
        ...
        let measurement_result: f64 = 1.2345; // Example homodyne result
    ...
    fn test_simulator_coherence_deadline() {
        ...
        let coherence_time: f64 = 10e-6; // 10 µs
        let measurement_time: f64 = 1e-6;
    ...
    fn test_simulator_health_check() {
        ...
        let health_states = ["Healthy", "Degraded", "Faulty"];
    ...
    fn test_simulator_resource_feedback_to_scheduler() {
        ...
        let allocated_resources = ["waveguide_0", "detector_0"];
    ...
    fn test_simulator_throughput_1000_shots() {
        ...
        let shots = 1000;
        let time_per_shot_ms: f64 = 0.5; // milliseconds
    ...
    fn test_simulator_compatible_with_phase_1_4_hal() {
        ...
        let phase_1_4_devices = ["simulator_v1"];
    ...
    fn test_simulator_adaptive_calibration() {
        ...
        let phases = ["pre_execution", "during_execution", "post_execution"];
    ...
    fn test_simulator_handles_zero_photons() {
        ...
        let signal = (photon_count - dark_baseline).max(0);
        assert_eq!(signal, 0);
    }
