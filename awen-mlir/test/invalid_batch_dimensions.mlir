...
module {
  func.func @invalid_batch_dimensions(%lhs: tensor<2x16x32xf32>, %rhs: tensor<2x32x8xf32>) -> tensor<2x16x8xf32> {
    // expected-error @+1 {{rank-three dot_general requires lhs and rhs batching dimension [0]}}
    %0 = "stablehlo.dot_general"(%lhs, %rhs) {
      lhs_batching_dimensions = array<i64: 0>,
      rhs_batching_dimensions = array<i64: 1>,
